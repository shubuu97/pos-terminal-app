...
const paymentReducer = (state = {
    ...
    switch (action.type) {
        ...
        case 'EMPLOYEE_PAYROLL':
            amountAvailToRedeem = _get(state, 'employeeAvailableAmount.limit.amount') || dineroObj(0, 'USD');
        ...
        case 'GIFT_AMOUNT_TO_REDEEM':
            let amountAvailToRedeem = _get(state, 'giftCardData.value.amount') || dineroObj(0, 'USD');
