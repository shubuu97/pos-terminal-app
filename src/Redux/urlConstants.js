...
if (process.env.NODE_ENV !== 'production') {
    APPLICATION_BFF_URL = "http://13.233.72.1:4005/"; //"https://devcreliasmb.allonblock.com";
    APP_QUICKBOOK_KEY = 'quickBook';
    APP_DUNS_NO_KEY = 'DUNSNumber';

    APP_QUICKBOOK_CLIENT_ID = "Q0WjOCLTcUwoDkPfAAkQ6IXcPYBbJzfd5ivIDqmCTmktWwz9E1";
    APP_QUICKBOOK_REDIRECT_URI = "http://localhost:3001/accounting/details";
